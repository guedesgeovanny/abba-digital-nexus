...
export function ConnectionCard({
  ...
  return (
    <Card className="bg-abba-black border-abba-gray p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-2">
                ...
                <span className={`px-2 py-0.5 text-xs rounded-full font-medium flex items-center gap-1 ${connected ? 'bg-abba-green text-abba-black' : 'bg-abba-gray text-abba-text'}`}>
          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            <div className="text-sm text-abba-text/80">Criado em:</div>
            <div className="text-right text-sm text-abba-text/80">{formatDate(createdAt)}</div>
            <div className="text-sm text-abba-text/80">Última atividade:</div>
            <div className="text-right text-sm text-abba-text/80">{formatDate(updatedAt || createdAt)}</div>
          </div>

          <div className="mt-4">
            <Button variant="outline" className="w-full border-abba-gray text-abba-text" onClick={handleDisconnect}>
